 ...
 * @author milo
 */
public class FullNotif extends javax.swing.JFrame {

    /**
     * Creates new form FullNotif
     */
    public FullNotif() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Trash Can is Full!");
        jPanel1.add(jLabel1);
        jLabel1.setBounds(80, 60, 190, 29);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FullNotif.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
