 ...
 * @author milo
 */
public class HailHospLoc extends javax.swing.JFrame {

    /**
     * Creates new form HailHospLoc
     */
    public HailHospLoc() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(HailHospLoc.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new HailHospLoc().setVisible(true);
            }
        });
    }
