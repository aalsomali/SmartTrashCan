 ...
 * @author milo
 */
public class HailMallLoc extends javax.swing.JFrame {

    /**
     * Creates new form HailMallLoc
     */
    public HailMallLoc() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        locButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/Scan.jpg"))); // NOI18N
    ...
    private void locButtonMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_locButtonMouseClicked
        ScanNotif sn = new ScanNotif();
        sn.setVisible(true);
        if(sn.isVisible()==false)
            this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(HailMallLoc.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new HailMallLoc().setVisible(true);
            }
        });
    }
