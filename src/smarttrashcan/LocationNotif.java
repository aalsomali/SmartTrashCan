 ...
 * @author milo
 */
public class LocationNotif extends javax.swing.JFrame {

    /**
     * Creates new form LocationNotif
     */
    public LocationNotif() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel1);
        jLabel1.setBounds(20, 80, 310, 22);

        jLabel2.setFont(new java.awt.Font("Tahoma", 0, 24)); // NOI18N
        jLabel2.setText("Access Your Location While");
        jPanel1.add(jLabel2);
        jLabel2.setBounds(20, 110, 290, 30);

        jLabel3.setFont(new java.awt.Font("Tahoma", 0, 24)); // NOI18N
        jLabel3.setText("Using App?");
        jPanel1.add(jLabel3);
        jLabel3.setBounds(100, 150, 140, 29);

        jButton1.setBackground(new java.awt.Color(228, 253, 192));
        jButton1.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jButton1.setText("Don't Allow");
        jPanel1.add(jButton1);
        jButton1.setBounds(30, 230, 130, 40);
        ...
        jPanel1.add(Allow);
        Allow.setBounds(190, 230, 120, 40);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LocationNotif.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new LocationNotif().setVisible(true);
            }
        });
    }
