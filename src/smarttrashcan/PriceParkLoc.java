 ...
 * @author milo
 */
public class PriceParkLoc extends javax.swing.JFrame {

    /**
     * Creates new form PriceParkLoc
     */
    public PriceParkLoc() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PriceParkLoc.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PriceParkLoc().setVisible(true);
            }
        });
    }
