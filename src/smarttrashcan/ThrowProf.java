 ...
 * @author milo
 */
public class ThrowProf extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ThrowProf.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
